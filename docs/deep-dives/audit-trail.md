# Audit Trail — Engineering Journal
...
- **No cryptographic immutability** — ops can DEL keys; not a compliance ledger blockchain.

## Failure modes

1. **Queue saturated** — audit dropped; metric fires; decision still enforced.
